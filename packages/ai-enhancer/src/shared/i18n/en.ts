export const enLocale = {
  ...
  'ai-enhancer-references-label': 'Reference images',
  'ai-enhancer-references-add': 'Add reference image',
  'ai-enhancer-references-remove': 'Remove reference image',
  'ai-enhancer-references-error': 'Upload failed. Tap to retry.',
