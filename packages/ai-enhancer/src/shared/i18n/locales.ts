import { type AiEnhancerLocale, enLocale } from './en';

export type LocaleLoader = () => Promise<AiEnhancerLocale>;

/**
 * Every locale the ai-enhancer ships, mirroring the file-uploader's locale set.
