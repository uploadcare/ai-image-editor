...
const locale: AiEnhancerLocale = {
  ...
  'ai-enhancer-references-label': 'Viðmiðunarmyndir',
  'ai-enhancer-references-add': 'Bæta við viðmiðunarmynd',
  'ai-enhancer-references-remove': 'Fjarlægja viðmiðunarmynd',
  'ai-enhancer-references-error': 'Upphal mistókst. Ýttu til að reyna aftur.',
