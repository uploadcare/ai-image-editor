...
const locale: AiEnhancerLocale = {
  ...
  'ai-enhancer-references-label': '参照画像',
  'ai-enhancer-references-add': '参照画像を追加',
  'ai-enhancer-references-remove': '参照画像を削除',
  'ai-enhancer-references-error': 'アップロードに失敗しました。タップで再試行。',
