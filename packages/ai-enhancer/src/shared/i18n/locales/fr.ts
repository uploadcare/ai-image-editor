...
const locale: AiEnhancerLocale = {
  ...
  'ai-enhancer-references-label': 'Images de référence',
  'ai-enhancer-references-add': 'Ajouter une image de référence',
  'ai-enhancer-references-remove': 'Supprimer l’image de référence',
  'ai-enhancer-references-error': 'Échec du téléversement. Touchez pour réessayer.',
