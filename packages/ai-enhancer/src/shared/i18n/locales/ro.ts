...
const locale: AiEnhancerLocale = {
  ...
  'ai-enhancer-references-label': 'Imagini de referință',
  'ai-enhancer-references-add': 'Adaugă imagine de referință',
  'ai-enhancer-references-remove': 'Elimină imaginea de referință',
  'ai-enhancer-references-error': 'Încărcarea a eșuat. Atinge pentru a reîncerca.',
