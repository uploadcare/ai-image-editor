...
const locale: AiEnhancerLocale = {
  ...
  'ai-enhancer-references-label': 'İstinad şəkilləri',
  'ai-enhancer-references-add': 'İstinad şəkli əlavə et',
  'ai-enhancer-references-remove': 'İstinad şəklini sil',
  'ai-enhancer-references-error': 'Yükləmə alınmadı. Yenidən cəhd üçün toxunun.',
