...
const locale: AiEnhancerLocale = {
  ...
  'ai-enhancer-references-label': 'Հղման պատկերներ',
  'ai-enhancer-references-add': 'Ավելացնել հղման պատկեր',
  'ai-enhancer-references-remove': 'Հեռացնել հղման պատկերը',
  'ai-enhancer-references-error': 'Վերբեռնումը ձախողվեց։ Հպեք՝ կրկնելու համար։',
