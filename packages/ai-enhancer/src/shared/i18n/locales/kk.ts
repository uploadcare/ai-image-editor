...
const locale: AiEnhancerLocale = {
  ...
  'ai-enhancer-references-label': 'Анықтамалық суреттер',
  'ai-enhancer-references-add': 'Анықтамалық сурет қосу',
  'ai-enhancer-references-remove': 'Анықтамалық суретті жою',
  'ai-enhancer-references-error': 'Жүктеу сәтсіз аяқталды. Қайталау үшін түртіңіз.',
