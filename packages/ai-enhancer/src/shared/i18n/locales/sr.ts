...
const locale: AiEnhancerLocale = {
  ...
  'ai-enhancer-references-label': 'Референтне слике',
  'ai-enhancer-references-add': 'Додај референтну слику',
  'ai-enhancer-references-remove': 'Уклони референтну слику',
  'ai-enhancer-references-error': 'Отпремање није успело. Додирните за поновни покушај.',
