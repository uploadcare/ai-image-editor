...
const locale: AiEnhancerLocale = {
  ...
  'ai-enhancer-references-label': 'Atsauces attēli',
  'ai-enhancer-references-add': 'Pievienot atsauces attēlu',
  'ai-enhancer-references-remove': 'Noņemt atsauces attēlu',
  'ai-enhancer-references-error': 'Augšupielāde neizdevās. Pieskarieties, lai mēģinātu vēlreiz.',
