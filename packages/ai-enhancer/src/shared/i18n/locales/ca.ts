...
const locale: AiEnhancerLocale = {
  ...
  'ai-enhancer-references-label': 'Imatges de referència',
  'ai-enhancer-references-add': 'Afegeix imatge de referència',
  'ai-enhancer-references-remove': 'Elimina la imatge de referència',
  'ai-enhancer-references-error': 'Ha fallat la pujada. Toca per reintentar.',
