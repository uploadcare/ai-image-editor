...
const locale: AiEnhancerLocale = {
  ...
  'ai-enhancer-references-label': '참조 이미지',
  'ai-enhancer-references-add': '참조 이미지 추가',
  'ai-enhancer-references-remove': '참조 이미지 제거',
  'ai-enhancer-references-error': '업로드 실패. 다시 시도하려면 누르세요.',
