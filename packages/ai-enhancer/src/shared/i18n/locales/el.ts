...
const locale: AiEnhancerLocale = {
  ...
  'ai-enhancer-references-label': 'Εικόνες αναφοράς',
  'ai-enhancer-references-add': 'Προσθήκη εικόνας αναφοράς',
  'ai-enhancer-references-remove': 'Αφαίρεση εικόνας αναφοράς',
  'ai-enhancer-references-error': 'Η μεταφόρτωση απέτυχε. Πατήστε για επανάληψη.',
