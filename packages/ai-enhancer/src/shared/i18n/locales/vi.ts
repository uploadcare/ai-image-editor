...
const locale: AiEnhancerLocale = {
  ...
  'ai-enhancer-references-label': 'Ảnh tham chiếu',
  'ai-enhancer-references-add': 'Thêm ảnh tham chiếu',
  'ai-enhancer-references-remove': 'Xóa ảnh tham chiếu',
  'ai-enhancer-references-error': 'Tải lên thất bại. Chạm để thử lại.',
