...
- **[Components](/api/components)** — the web-component API for `<uc-ai-enhancer>`:
...
| Import | Exports |
|---|---|
| `@uploadcare/ai-enhancer` | `<uc-ai-enhancer>` registration, `UploadcareDerivativeApi`, all editor/provider types, and the localization helpers. |
