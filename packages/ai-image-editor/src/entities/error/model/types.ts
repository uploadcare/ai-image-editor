 ...
 * The UI maps `code` to a localized message (`ai-image-editor-error-<code>`).
 */
export class AiImageEditorError extends Error {
  public readonly code: AiImageEditorErrorCode;
  public readonly source?: string;
  // declared locally: `Error.cause` needs lib ES2022+, this package targets ES2020
  public readonly cause?: unknown;

  public constructor(message: string, options: AiImageEditorErrorOptions = {}) {
    super(message);
    this.name = 'AiImageEditorError';
